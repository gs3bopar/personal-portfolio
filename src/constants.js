export const ABOUT_ME = Object.freeze({
  ...
  WORKING: "Software Developer working for TD Securities. Passionate about software and using tech to make the world a better place.",
  MY_STORY_STRING: "My Story",
  MY_STORY_EXPLAIN: "I graduated with a Bachelor of Computer Science degree from the University of Waterloo, before working at TD Securities I worked (mostly interships) all over Canada and USA. My mission is to work collaboratively with others to solve real-world problems with fresh, creative tech solutions that follow industry best practices.",
  STRING: "ABOUT ME",
});
...
export const CONTACT_ME = Object.freeze({
  STRING: "CONTACT ME",
  EMAIL: "Email",
  EMAIL_LINK: "gs3bopar@uwaterloo.ca",
